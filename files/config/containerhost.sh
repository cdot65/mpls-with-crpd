...
# p[1-2]
docker exec -it clab-mpls001-p1 ip addr add 192.168.105.141/24 dev eth1
...
docker exec -it clab-mpls001-p2 ip addr add 192.168.105.142/24 dev eth1
...
docker exec -it clab-mpls001-p1 ip addr add 10.1.5.2/24 dev eth7
